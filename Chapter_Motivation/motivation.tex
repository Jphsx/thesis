...
An aesthetic attribute of theoretical models the intrinsic naturalness, we should expect a model to function "naturally" if the ratio of free parameters in a model are of $O(1)$. Large swings between parameters would be considered "fine tuning" and could indicate issues with the underlying theory. So, naturally, the %. We would expect with some improved theory with new physics one would balance out finely tuned parameters providing a natural solution to whatever is being modeled. 
