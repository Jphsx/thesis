...
\FigureThree{gold_ele_TTJets_Fall17.pdf}{silver_ele_TTJets_Fall17.pdf}{bronze_ele_TTJets_Fall17.pdf}{Gold (Top-Left), Silver (Top-Right) and Bronze (Bottom) MC truth matching in TTJets sample 2017. Signal is defined here as prompt electrons from a $W$ decay. \textit{Source A. Abreu} \cite{AN}}{andresPurity}

\FigureOne{sigEff_ele_TTJets_Fall17.pdf}{Gold, Silver, and Bronze efficiency on truth matched prompt electrons as signal and secondary electons as Fakes. \textit{Source A. Abreu} \cite{AN}}{andresEff}
...
\FigFour{Lep_Obj_plots/h_2017_0_eleff.pdf}{Lep_Obj_plots/h_2017_1_eleff.pdf}{Lep_Obj_plots/h_2017_2_eleff.pdf}{Lep_Obj_plots/h_2017_3_eleff.pdf}{The 2017 individually measured electron efficiencies for Very Loose, ID, Isolation, and Impact parameter in bins of $p_T$ and $|\eta|$.}{fig:el2deff}


\FigThree{Lep_Obj_plots/h_2017_1_el.pdf}{Lep_Obj_plots/h_2017_2_el.pdf}{Lep_Obj_plots/h_2017_3_el.pdf}{The 2017 combined electron efficiencies for Gold, Silver, and Bronze. }{fig:elgsb}
