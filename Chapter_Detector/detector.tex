...
\FigOneScale{Detector_figs/CMSParticleDetectionSummary.png}{Transverse slice of the CMS detector. Illustrates the components that specialize in detecting specific particles \cite{CMS:2017yfk}.}{fig:cmsdet}{0.85}
