...
\FigOne{Detector_figs/detector_old.png}{detector from old paper}{fig:det}
...
\FigOne{Detector_figs/CMSParticleDetectionSummary.png}{plot from CMS of CMS \cite{something}}{fig:cmsdet}
