...
%bronze only fit
\FigTwoScale{Model_figs/1L_B_0J_b-fit.pdf}{Model_figs/2L_B_2J_b-fit.pdf}{The Bronze only category fit with fake dominated 1 lepton and 2 lepton bronze categories.}{fig:crvrsummary}{0.9}{0.9}
\section{Bias tests}
