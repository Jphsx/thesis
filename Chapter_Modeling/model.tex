...
\FigTwoScale{Model_figs/build62_pull_run2_nopoisson.pdf}{Model_figs/build62_pull_run2_poisson.pdf}{Comparison of Run II CR fits with Build 62 of \ref{tab:builds} without Poisson treatment (left) and with Poisson treatment (right). The improvement by implementing the Poisson treatment is shown in the RMS and fitted $\sigma$ of the right distribution, by reducing the number of large outliers due to bins with low statistics. }{fig:comparePoissonPull}{0.49}{0.49}
