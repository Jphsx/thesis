...
\FigOneScale{Analysis_figs/cleaningCuts.pdf}{Cleaning cuts designed to veto events in the red regions with significantly large data to MC $R_{ISR}$ ratios. The accepted region corresponds to events passing the last two criteria of Table \ref{tab:presel} \textit{Source: Z. Flowers} \cite{AN}}{fig:cleancut}{0.75}
