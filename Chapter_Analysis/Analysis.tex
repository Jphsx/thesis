...
\FigOneScale{Analysis_figs/cleaningCuts.pdf}{Cleaning cuts designed to veto events in the red regions with significantly large data to MC $R_{ISR}$ ratios. Combines a flat cut and veto based on 2D function of $p_T^{CM}$ and $\Delta\phi_{CM,I}$  \textit{Source: Z. Flowers} \cite{AN}}{fig:cleancut}{0.75}
